...
| Q26 | 10 积分/会话含 20 轮、超轮 1 积分/轮、50 轮上限 |
...
- **状态机**：trial → active（充值即转）→ paused（余额<场景最小价 10）→ expired；欠费整页冻结，充值 1 分钟恢复
- **余额预警**：<30 积分琥珀色预警
...
| 计费验证 | 冻结 10×5 / 超轮 1+幂等重放 0 / 第 20 轮免扣 / 第 51 轮 429 / 生图 15×10 / 余额守恒 | 精确 | ✅ |
